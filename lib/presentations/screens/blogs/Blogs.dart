...
class _BlogsState extends State<Blogs> {
  ...
  void _showAddBlogDialog(BuildContext context) {
    ...
    final _authorTypeController = TextEditingController(text: "USER"
        "");
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: isLoading ?  SizedBox(height: 20, width: 20, child: CircularProgressIndicator(color: Colors.white,),) :  const Text("Add Blog"),
            ),
          ],
        );
      },
